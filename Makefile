...
ifeq ($(PLATFORM),PLATFORM_WEB)
    ...
    CFLAGS += -s USE_GLFW=3 -s TOTAL_MEMORY=16777216 -s ASYNCIFY=1 --preload-file resources -O2 --memory-init-file 0 -Wno-delete-non-abstract-non-virtual-dtor
...
PROJECT_SOURCE_FILES ?= snacman.cpp
